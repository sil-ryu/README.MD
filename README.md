...
```
龍  S I L R A G O N  R Y U  龍
```

# Ahmed Boray · シルラゴン・リュー

**`AI/ML Engineer · Full-Stack Dev · Researcher`**

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=16&pause=1000&color=A8B5C8&center=true&vCenter=true&width=600&lines=Building+systems+that+think+and+act.;Computer+Engineering+%40+Istinye+University;Published+Researcher+%7C+EHJ+Digital+Health+%272026;Intern+%40+AITC+%7C+Django+%C2%B7+Tailwind+%C2%B7+DevOps;Silragon+Ryu+%E2%80%94+silver+%2B+%E7%AB%9C)](https://git.io/typing-svg)
...
```
// mission  → build systems that bite back
// status   → graduating Jun 2026 · shipping daily
```
...
I'm an AI/ML engineer and full-stack developer finishing my Computer Engineering degree at **Istinye University** (Istanbul). My work lives at the intersection of deep learning, embedded systems, and production software — from edge-deployed security AI running on a Raspberry Pi to published medical imaging research.

- 🔬 **Student Researcher** — TÜBİTAK-funded deep learning for pediatric cardiovascular MRI segmentation
- 📄 **2× Undergraduate Publications** — *European Heart Journal Digital Health* (2026) · *TIPTEKNO* (2025)
- 🏢 **Intern @ AITC** (Saudi Arabia) — Django · Tailwind · DevOps
...
[![trophy](https://github-profile-trophy.vercel.app/?username=sil-ryu&theme=radical&no-frame=true&no-bg=true&margin-w=10&column=7&rank=SECRET,SSS,SS,S,AAA,AA,A,B)](https://github.com/ryo-ma/github-profile-trophy)

<br/>

[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=sil-ryu&theme=radical&hide_border=true&area=true)](https://github.com/Ashutosh00710/github-readme-activity-graph)
...
```
竜は常に前へ — The dragon always moves forward.
```
